...
namespace CodingChallenge2.Util
{
    internal class DBUtil
    {
        const string connectionString = @"Server =LAPTOP-8EEUCOL7\SQLEXPRESS ; Database = Loan ; Integrated Security =True ; MultipleActiveResultSets=true;";
